...
logger = get_logger("YahooCrawler")
...
class YahooCrawler:
    def __init__(self, n_urls: int, initial_urls: str, base_page: str): 
        ...
        """
        self.url_queue = deque(read_initial_urls(initial_urls))
    ...
    def crawl_urls(self) -> None:
        ...
        try:
            while self.url_queue:
                ...
                logger.info(f"Currently Scraping URL Nr.{i}, time: {(time.time() - start_time) / 3600:.4f} h")
